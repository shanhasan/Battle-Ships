...
describe Cell do
  ...
  let (:water) { double :water, { :class => Water } } #{ :is_a? => true } }
  ...
  context 'initializing the cell' do
    ...
    it 'will initialize containing water' do
      expect(cell.contents).to be(water)
    end
  ...
  #   it 'will allow ship to be hit if inside cell' do
  #     cell.hold(ship)
  #     expect(ship).to receive(:hit_ship!)
  #     cell.hit!
  #   end
